...
public partial class Admin_Products_Details : System.Web.UI.Page
{
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        {
            con.Open();
            string SQL = @"UPDATE Products SET Name=@Name, CatID=@CatID, Code=@Code, Description=@Description, Image=@Image, Price=@Price, IsFeatured=@IsFeatured, CriticalLevel=@CriticalLevel, Maximum=@Maximum, DateModified=@DateModified WHERE ProductID=@ProductID";
